...
class PofileFollowerContainer extends Component {
    ...
    render() {
        ...
        // 팔로우하기 버튼
        const btn = (flag === true) ? 
        (<Button size="tiny" basic color='grey' onClick={()=>{this.onModal(true)}} >팔로잉취소</Button>)   :
        (<Button size="tiny" basic color='grey' onClick={()=>{this.onFollow(follower.accountId)}}>팔로잉</Button>);
